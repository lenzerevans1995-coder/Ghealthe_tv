...
const CONTEST_FLYER = '/assets/contest-flyer-aug11.jpg';
...
(function(){
  ...
  function measure(){
    ...
    // The live ticker owns a strip across the top: scale into what is left
    // and push the stage down half a strip so it stays centred underneath.
    var bar = document.getElementById('ghe-ticker');
    var t = bar ? bar.offsetHeight : 0;
    if (t) { h -= t; stage.style.top = 'calc(50% + ' + (t / 2) + 'px)'; }
    return [w, h];
  }
  var lw = 0, lh = 0;
  function fit(force){
